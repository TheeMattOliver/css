...
import compiler from './graphemic-css-compiler.js'
...
// and values are the bundle file base name. ("graphemic" produces
// "dist/graphemic.css", etc.)
const bundleNames = {
  'index.scss': 'graphemic'
}
...
async function writeVariableData() {
  ...
  // this function only returns stuff from support bc 'marketing' doesn't exist
  const data = Object.assign({}, support, null)
